    ...
    public class EmployeeController : Controller
    {
        ...
        public ActionResult IndexP(int pos)
        {
            ...
            using (SqlConnection sqlCon = Helpers.GetConnection())
            {
                ...
                {
                    sqlDa = new SqlDataAdapter("SELECT * FROM Employee E inner join Position P on E.employeeId=P.employeeid where depId=@depId", sqlCon);
        ...
        public IActionResult Create(Employee emp)
        {
            using (SqlConnection sqlCon = Helpers.GetConnection())
            {
                ...
                sqlCon.Open();
                string query = "INSERT INTO Employee(employeeId,firstname,lastname,birthday,active,position) VALUES(@EmployeeId,@FirstName,@LastName,@Birthday,@Active,@Position)";
